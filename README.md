...
Each run generates `UART.vcd`, viewable in Vivado's waveform viewer, GTKWave, or any VCD-compatible tool. In here waveform is particularly generated in vivado.
